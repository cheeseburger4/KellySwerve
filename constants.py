...
class RKelly:
    wheel_size = 0.1 # meters
    max_module_speed =  4.654 # m/s
    max_rot_rate = 10.472 # rad/s
    drive_base_radius = 0.43 # meters
...
LEFT_FRONT_CANCODER = 5
LEFT_BACK_CANCODER = 6
RIGHT_FRONT_CANCODER = 7
RIGHT_BACK_CANCODER = 8
